...
import { apiContext, apiEndpoints, Spinner, useApi, Link, Button } from "ractf";
...
export default () => {
    ...
    return <Page>
        ...
        {api.challenges ? <>
            ...
            <div className={"homeSub"}>Looks like you're not signed in. Let's fix that!</div>
            <Button className={"homeButton"} to={"/login"}>Login</Button>
            </div>}
    </Page>;
