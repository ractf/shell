...
export default () => <Page>
    ...
    <p>Really Awesome Technology Ltd ("us", "we", or "our") operates the https://ractf.co.uk website (the "Service").</p>
    ...
    <p>We may also collect information how the Service is accessed and used ("Usage Data"). This Usage Data may include
        information such as your computer's Internet Protocol address (refered to as "IP address" in the remainder of
        this document), browser type, browser version, the pages of our Service that you visit, the time and date of
    ...
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that transfer.</p>
    <p>Really Awesome Technology Ltd will take all steps reasonably necessary to ensure that your data is treated securely and in
    ...
    <p>Really Awesome Technology Ltd may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
    ...
    <p>We may also let you know via email and/or a prominent notice on our Service, prior to the change becoming
