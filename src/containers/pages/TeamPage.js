                ...
                {teamData.social && <>
                    {teamData.social.twitter && teamData.social.twitter.length !== 0 &&
                        <a className={"userSocial"} target={"_blank"}
                            href={"https://twitter.com/" + encodeURIComponent(teamData.social.twitter)}>
                            <FaTwitter /><span>@{teamData.social.twitter}</span>
                        </a>}
                    {teamData.social.reddit && teamData.social.reddit.length !== 0 &&
                        <a className={"userSocial"} target={"_blank"}
                            href={"https://reddit.com/u/" + encodeURIComponent(teamData.social.reddit)}>
                            <FaRedditAlien /><span>/u/{teamData.social.reddit}</span>
                        </a>}
                    {teamData.social.discord && teamData.social.discord.length !== 0 &&
                        (teamData.social.discordid && teamData.social.discordid.length !== 0
                            ? <a target={"_blank"}
                                href={"https://discordapp.com/users/" + encodeURIComponent(teamData.social.discordid)}
                                className={"userSocial"}>
                                <FaDiscord /><span>{teamData.social.discord}</span>
                            </a>
